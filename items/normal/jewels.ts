...
export const jewelsGroup = new Group({ name: "Jewels" }).addParent(normalGroup);

export const diamond = new JewelType("Diamond", 40).physical();
export const ruby = new JewelType("Ruby", 131).physical();
export const emerald = new JewelType("Virtual Emerald", 148)
  .virtual()
  .addIcons("emerald", "virtual_emerald", "gardenpin");
...
export const amethyst = new JewelType("Virtual Amethyst", 290)
  .addIcons("virtual_amethyst", "amethyst")
  .virtual();
export const pinkDiamond = new JewelType("Pink Diamond", 584).physical();
export const sapphire = new JewelType("Virtual Sapphire", 681)
  .addIcons("virtual_sapphire", "sapphire")
  .virtual();
export const citrine = new JewelType("Virtual Citrine", 2361)
  .addIcons("virtual_citrine", "citrine")
  .virtual();
