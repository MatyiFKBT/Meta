...
export const PlacesGroup = new Group({ name: "Places" }).addParent(normalGroup);
...
export const poiHistoricalPlace = new PlacesType("POI Historical Place", 1339).addIcon(
  "poihistorical"
);
...
export const poiFaithPlace = new PlacesType("POI Faith Place", 1342).addIcon("poifaith");
