...
import { ScatterType, Type, TypeHidden, TypeSet, TypeTags } from "../../src/common/type";
...
export const egyptianZodiacScatters = new TypeSet()
  ...
  .add(new EgyptianZodiacScatterType("Scarab Artifact", 2766))
  .add(new EgyptianZodiacScatterType("Eye of Ra Artifact", 2767))
  .add(new EgyptianZodiacScatterType("Shen Artifact", 2768))
