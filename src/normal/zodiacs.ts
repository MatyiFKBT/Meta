...
export const bastet = new EgyptianZodiacType("Bastet", 2759);
export const isis = new EgyptianZodiacType("Isis", 2760);
export const mut = new EgyptianZodiacType("Mut", 2761);
export const geb = new EgyptianZodiacType("Geb", 2762);
