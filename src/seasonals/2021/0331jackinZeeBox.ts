...
export const blastinZeeBox = new JackInZeeBoxType("Blast in the Box")
  .addGroup(jackinZeeBoxGroup)
  .addHidden(TypeHidden.Bouncers);
export const boxingGlove = new JackInZeeBoxType("Boxing Glove")
  .addGroup(jackinZeeBoxGroup)
  .addHidden(TypeHidden.Bouncers);
export const firePrankster = new JackInZeeBoxType("Fire Prankster")
  .addGroup(jackinZeeBoxGroup)
  .addHidden(TypeHidden.Bouncers);
export const highFive = new JackInZeeBoxType("High Five")
  .addGroup(jackinZeeBoxGroup)
  .addHidden(TypeHidden.Bouncers);
export const icePrankster = new JackInZeeBoxType("Ice Prankster")
  .addGroup(jackinZeeBoxGroup)
  .addHidden(TypeHidden.Bouncers);
export const prankster = new JackInZeeBoxType("Prankster")
  .addGroup(jackinZeeBoxGroup)
  .addHidden(TypeHidden.Bouncers);
export const rOBblehead = new JackInZeeBoxType("ROBblehead")
  .addGroup(jackinZeeBoxGroup)
  .addHidden(TypeHidden.Bouncers);
export const unicorn = new JackInZeeBoxType("Unicorn")
  .addGroup(jackinZeeBoxGroup)
  .addHidden(TypeHidden.Bouncers);
