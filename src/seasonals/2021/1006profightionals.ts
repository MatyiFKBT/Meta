...
export const frankEinstein = new Year2021SeasonalPOBType("Frank Einstein").addGroup(
  profightionalsGroup
);
export const fabiOooOooo = new Year2021SeasonalPOBType("FabiOooOooo")
  .addIcon("fabioooooo")
  .addGroup(profightionalsGroup);
export const drAcula = new Year2021SeasonalPOBType("Dr. Acula").addGroup(profightionalsGroup);
export const backstitchSisters = new Year2021SeasonalPOBType("Backstitch Sisters").addGroup(
  profightionalsGroup
);
